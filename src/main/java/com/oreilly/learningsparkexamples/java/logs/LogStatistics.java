...
public class LogStatistics implements Serializable {
	...
	public final static LogStatistics EMPTY_LOG_STATISTICS = new LogStatistics(new Tuple4<>(0L, 0L, 0L, 0L), new ArrayList<Tuple2<Integer, Long>>(),
	...
	public LogStatistics(Tuple4<Long, Long, Long, Long> contentSizeStats, List<Tuple2<Integer, Long>> responseCodeToCount, List<String> ipAddresses,
